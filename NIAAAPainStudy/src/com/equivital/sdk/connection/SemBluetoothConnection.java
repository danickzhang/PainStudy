...
import edu.missouri.niaaa.pain.sensor.SensorConnections;
import edu.missouri.niaaa.pain.sensor.SensorUtilities;
import edu.missouri.niaaa.pain.services.SensorLocationService;
...
public class SemBluetoothConnection implements ISemConnection
{
    ...
    public class Reconnect extends TimerTask{
		...
		public void run() {
			...
			Log.d("SEM","Reconnection Started "+reConnectCount);
			if(isConnected()!=true && reConnectCount<=10 && !SensorLocationService.cancelBlueToothFlag)
			{
				Log.d("SEM","connect");
			...
			else
			{
				...
				if(isConnected()!=true)
				{
			        ...
			        if (!SensorLocationService.cancelBlueToothFlag){
			        	...
			        	SensorLocationService.serviceContext.sendBroadcast(i);
			        }
				}
			}
