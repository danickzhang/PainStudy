...
import edu.missouri.niaaa.pain.survey.category.SurveyAnswer;
import edu.missouri.niaaa.pain.survey.category.SurveyCategory;
import edu.missouri.niaaa.pain.survey.question.CheckQuestion;
import edu.missouri.niaaa.pain.survey.question.NumberQuestion;
import edu.missouri.niaaa.pain.survey.question.RadioInputQuestion;
import edu.missouri.niaaa.pain.survey.question.RadioQuestion;
import edu.missouri.niaaa.pain.survey.question.TextQuestion;
...
//              Util.Log_debug(TAG, "Random tag category");
            }
            else{
                category = new SurveyCategory();
//              Util.Log_debug(TAG, "regular tag category");
            }
        }
