...
/*      trigger survey*/
            ...
            if(tri < triggerMax){
                ...
                //for followup survey
                else if(surveyName.equals(Utilities.SV_NAME_DRINKING_FOLLOWUP)){
...
//          launchSurvey.putExtra(Utilitieslities.SV_FILE, Utilitieslities.SV_MAP.get(surveyName));
            ...
            if(shp.getInt(Utilities.SP_KEY_SURVEY_REMINDER_SEQ, 0) < Util.MAX_REMINDER && !shp.getBoolean(Utilities.SP_KEY_SURVEY_UNDERGOING, false)){// <max, false
                ...
                am.set(AlarmManager.RTC_WAKEUP, Calendar.getInstance().getTimeInMillis() + Utilities.REMINDER_IN_SECONDS * 1000, piReminder);
